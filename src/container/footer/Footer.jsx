  ...
  return (
    ...
    <div className='app__footer-cards'>
      <div className='app__footer-card'>
        ...
        <a href="mailto:abideen1052@gmail.com" className='p-text'>abideen1052@gmail.com</a>
      </div>
      <div className='app__footer-card'>
        <img src={images.mobile} alt="mobie" />
        <a href="tel: +91 8714120660" className='p-text'>+91 8714120660</a>
      </div>
    </div>
